<template>
  <div>
    <a href="https://redstapler.co" target="_blank" class="text-3d">404</a>
    <span @click="backToHome" class="caption">Click to Return Home</span>
  </div>
</template>
...
span:hover {
  ...
  text-shadow: 0 3px 5px rgb(213, 213, 213);
  cursor: pointer;
}
.text-3d {
