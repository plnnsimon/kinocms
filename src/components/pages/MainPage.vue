<template>
  <div class="news-page">
    <div class="switcher">
      <p>Статус:</p>
      <label class="switch">
        <input v-model="main_page.checked" type="checkbox" />
    ...
    <div class="container">
      <div class="news-top-section">
        <div class="phone-number">
          ...
          <input
            v-model="main_page.phone1"
            type="text"
            placeholder="777 85 98"
          />
          <input
            v-model="main_page.phone2"
            type="text"
            placeholder="777 85 98"
          />
        </div>
      ...
      <div class="seo">
        ...
        <form>
          ...
          <input
            v-model="main_page.seo.keywords"
            type="text"
            id="keywords"
          ...
          <textarea
            v-model="main_page.seo.description"
            type="text"
            id="description"
